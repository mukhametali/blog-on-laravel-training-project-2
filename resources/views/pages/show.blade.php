            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{ asset('images/comment.jpg') }}" class="pull-left img-circle" alt="">
                        <h4>Rubel Miah</h4>
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img class="img-circle" src="{{ asset('images/comment-img.jpg') }}" alt="">
                        </div>
                    ...
                    <div class="primary-sidebar">
                        ...
                        <aside class="widget pos-padding">
                            ...
                            <div class="instragram-follow">
                                <a href="#">
                                    <img src="{{ asset('images/ins-flow.jpg') }}" alt="">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('images/ins-flow.jpg') }}" alt="">
                                </a>
