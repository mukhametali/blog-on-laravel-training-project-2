                ...
                <div class="col-md-8">
                    <article class="post">
                        <div class="post-thumb">
                            <a href="blog.html"><img src="{{ asset('images/blog-1.jpg') }}" alt=""></a>
                    ...
                    <article class="post">
                        <div class="post-thumb">
                            <a href="blog.html"><img src="{{ asset('images/abc.jpg') }}" alt=""></a>
                    ...
                    <article class="post">
                        <div class="post-thumb">
                            <a href="blog.html"><img src="{{ asset('images/blog-2.jpg') }}" alt=""></a>
                    ...
                    <article class="post">
                        <div class="post-thumb">
                            <a href="blog.html"><img src="{{ asset('images/blog-3.jpg') }}" alt=""></a>
                    ...
                    <article class="post">
                        <div class="post-thumb">
                            <a href="blog.html"><img src="{{ asset('images/blog-4.jpg') }}" alt=""></a>
                            ...
                            <div class="thumb-latest-posts">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#" class="popular-img"><img src="{{ asset('images/r-p.jpg') }}" alt="">
                                            <div class="p-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="p-content">
